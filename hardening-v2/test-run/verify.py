...
expected_refs = read_json("verifier_inputs/primary/expected_refs.json")
...
spec = read_json("verifier_inputs/primary/commit_graph_spec.json")["branches"]
...
expected_checksums = read_json("verifier_inputs/primary/expected_file_checksums.json")
with tempfile.TemporaryDirectory() as td:
...
with tempfile.TemporaryDirectory() as td:
    ...
    partial_refs = read_json("verifier_inputs/recovery_cases/partial_overlap/expected_refs.json")
